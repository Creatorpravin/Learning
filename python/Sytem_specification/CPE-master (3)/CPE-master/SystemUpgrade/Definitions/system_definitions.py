...
SYSTEM_UPGRADE_UTILITIES_KEY = "utilities"
SYSTEM_UPGRADE_UTILITIES_PACKAGE_KEY = "package_name"
SYSTEM_UPGRADE_UTILITIES_VERSION_KEY = "version"

# Version
CPE_VERSION_FILE_PATH = BASE_DIRECTORY + "CPE/version.txt"

# Python requirements
PYTHON_REQUIREMENTS_FILE_PATH = BASE_DIRECTORY + "CPE/requirements.txt"
PYTHON_UPGRADE_SCRIPT = BASE_DIRECTORY + "SystemUpgrade/python-upgrade-script.sh"

# Chiefnet
CHIEFNET_SERVICE = "chiefnet-sdwan.service"
SYSTEM_UPGRADE_JSON_FILE_PATH = BASE_DIRECTORY + "CPE/SystemUpgrade.json"
