...
class WebSocketManager:
    ...
    websocket_server_uri:
        endpoint of the server that the websocket client must connect to.
        eg: "wss://echo.websocket.org"
    ...
    def __init__(self, websocket_server_uri):
        self.__logger = Logger.get_logger(__name__)
        self.__logger.info("WebSocketManager initialization start")

        self.__websocket_server_uri = websocket_server_uri
