                ...
                if (lst[0].isdigit()):
                    ...
                    if(len(nxt_line_lst) == 6):
                        ...
                        if (sent == "0"):
                            # printing values in line protocol format
                            print(
                                f'iftop_traffic,interface={interface},sender={sender},receiver={receiver} receiveRate={float(received)}')
                        elif(received == "0"):
                            print(
                                f'iftop_traffic,interface={interface},sender={sender},receiver={receiver} sendRate={float(sent)}')
                        else:
                            print(
                                f'iftop_traffic,interface={interface},sender={sender},receiver={receiver} sendRate={float(sent)},receiveRate={float(received)}')
