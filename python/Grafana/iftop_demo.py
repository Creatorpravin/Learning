...
#                        print("--------------------------------------")
                        if (sent == "0"):
                            # printing values in line protocol format
                            print(f'iftop_traffic,interface={interface},sender={sender}/location={ip_locator(sender)},receiver={receiver}/location={ip_locator(receiver)} receiveRate={float(received)}')
                        elif(received == "0"):
                            print(f'iftop_traffic,interface={interface},sender={sender}/location={ip_locator(sender)},receiver={receiver}/location={ip_locator(receiver)} sendRate={float(sent)}')
                        else:
                            print(f'iftop_traffic,interface={interface},sender={sender}/location={ip_locator(sender)},receiver={receiver}/location={ip_locator(receiver)} sendRate={float(sent)},receiveRate={float(received)}')
