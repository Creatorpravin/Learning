...
# Configure logging for specific modules or components
__logger = logging.getLogger('module1')
__logger.setLevel(logging.INFO)  # Set the logging level for module1

# Create file handlers for each module
file_handler_module1 = logging.FileHandler('interface_monitoring.log')
file_handler_module1.setFormatter(logging.Formatter('%(asctime)s | %(levelname)s | %(module)s | %(message)s'))
__logger.addHandler(file_handler_module1)
